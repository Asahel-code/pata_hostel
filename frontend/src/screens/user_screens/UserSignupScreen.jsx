...
export const UserSignupScreen = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await AuthServices.register({ name, email, password, passwordConfirmation }).then((response) => {
        toast({
          ...toastProps,
          title: "Success",
          ...
          <div className='w-full md:w-1/2 border border-primary_color rounded-lg'>
            <section className="w-full h-full">
              <div className="text-center bg-primary_color rounded-t-md py-2">
                <h2 className="font-bold text-white uppercase text-xl md:text-2xl">Join us today</h2>
              </div>
